    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md animate-fade-up">
          ...
          <h1 className="mt-8 text-3xl">Create your account</h1>
          <p className="mt-2 text-ink-500 dark:text-ink-300">Join GoTicket and book your next journey in minutes.</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <input className="input" placeholder="Jane Traveller" {...register("name", { required: "Name is required" })} />
          ...
          <p className="mt-6 text-center text-sm text-ink-500 dark:text-ink-300">
            Already have an account? <Link href="/login" className="font-semibold text-brand-600 hover:underline dark:text-brand-300">Log in</Link>
          </p>
        </div>
      </div>
    </div>
